...
public class FeatureDefinitionGraphTest {
	...
	public void testAddDependency() {
		...
		assertThat(_graph.addDependentFeatureDefinition(feature1, feature1_1, parameter1_1)).isTrue();
	...
	public void testAddDependency_toDependentFeature() {
		...
		_graph.addFeatureDefinition(feature1);
		_graph.addDependentFeatureDefinition(feature1, feature1_1, parameter1_1);
		_graph.addDependentFeatureDefinition(feature1_1, feature1_1_1, parameter1_1_1);
	...
	public void testAddDependency_sameDependencyTwice() {
		...
		_graph.addFeatureDefinition(feature1);
		_graph.addDependentFeatureDefinition(feature1, feature1_1, parameter1_1);
		assertThat(_graph.addDependentFeatureDefinition(feature1, feature1_1, parameter1_1)).isFalse();
	...
	public void testAddDependency_circularDependencyByEdge() {
		...
		_graph.addFeatureDefinition(feature1);
		_graph.addDependentFeatureDefinition(feature1, feature2, parameter2);
		_graph.addDependentFeatureDefinition(feature2, feature1, parameter1);
	}
	...
	public void testAddDependency_circularDependencyByLongerPath() {
		...
		_graph.addFeatureDefinition(feature1);
		_graph.addDependentFeatureDefinition(feature1, feature2, parameter2);
		_graph.addDependentFeatureDefinition(feature2, feature3, parameter3);
		_graph.addDependentFeatureDefinition(feature3, feature1, parameter1);
	}
	...
	public void testAddDependency_nullParent() {
		...
		_graph.addDependentFeatureDefinition(null, feature, parameter);
	}
	...
	public void testAddDependency_nullChild() {
		FeatureDefinition feature = new FeatureDefinition("feature", new DummyDistribution());
		VariableDummyParameter parameter = new VariableDummyParameter();
		_graph.addDependentFeatureDefinition(feature, null, parameter);
	}

	@Test(expected = IllegalNullArgumentException.class)
	public void testAddDependency_nullParameter() {
		FeatureDefinition feature = new FeatureDefinition("feature", new DummyDistribution());
		_graph.addDependentFeatureDefinition(feature, feature, null);
	}
	...
	public void testGetDependentParameters() {
		...
		_graph.addFeatureDefinition(feature1);
		_graph.addDependentFeatureDefinition(feature1, feature1_1, parameter1_1);
		_graph.addDependentFeatureDefinition(feature1, feature1_2, parameter1_2);
	...
	public void testIterator() {
		...
		_graph.addDependentFeatureDefinition(feature1, feature1_1, parameter1_1);
		_graph.addDependentFeatureDefinition(feature2, feature2_1, parameter2_1);
	...
	public void testEquals() {
		...
		graph2.addDependentFeatureDefinition(feature1, feature1_1, parameter1_1);
		graph2.addDependentFeatureDefinition(feature2, feature2_1, parameter2_1);
