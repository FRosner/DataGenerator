...
public class DataGeneratorIntegrationTest {
	...
	public void testDataGenerator_csvExport_continuousFeatures() throws IOException {
		...
		_fd3 = new FeatureDefinition("fd3_pirateGold", new GaussianDistribution(5.4234324235235345E-14,
				2.243847294729784E-16));
		_fd4 = new FeatureDefinition("fd4_random1", new GaussianDistribution(-9, 1));
		_fd5 = new FeatureDefinition("fd5_temperatureMallorca", new GaussianDistribution(5.4234324235235345E+14,
				2.243847294729784E+16));
